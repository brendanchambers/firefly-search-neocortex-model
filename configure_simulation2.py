...
LOG_RAND_sigmaInh = 1  # suggesting we hold these constant and only vary excitatory connections
...
g_input = timedInputArray(t,i) : siemens
"""
...
# save in json format
saveName = config_prefix + ' networkconfig 2.json'
